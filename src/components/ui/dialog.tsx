...
>(({ className, children, closeClassName, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className={cn("absolute right-4 top-4 md:-right-12 md:-top-12 bg-white rounded-full p-2 text-black opacity-100 hover:bg-zinc-100 hover:opacity-100 shadow-lg ring-0 focus:ring-0 outline-none w-10 h-10 [&>svg]:w-6 [&>svg]:h-6 z-[150] transition-transform hover:scale-110", closeClassName)}>
